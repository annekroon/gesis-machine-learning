...
\section{Where we left off yesterday}
...
\begin{frame}[fragile]{Four fixes in (nearly) 1 line}

All together: tf$\cdot$idf, smart tokenization, explicit stopword removal, pruning
\begin{lstlisting}
...
\begin{frame}{Today: customize your preprocessing}
    Remember the black box nature of more modern models.  
    Already in the one-liner above, many choices are \emph{hidden}.
    
    \vspace{1cm}
    \pause
    
    $\Rightarrow$ Example of AI coding to highlight why understanding is important: use AI wisely!
\end{frame}
