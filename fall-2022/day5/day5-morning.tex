...
\begin{frame}{Continous vectors}
	\begin{itemize}
		...
		\item This way of \emph{embedding} tokens is refered to as \emph{continous} or \emp{distributed} vectors, representations or \emph{word embeddings}
...
\item ...however, the \emp{meaning} of this word differs across domains: ``she put a \emph{date} in his lunchbox'' (1); ``they went on a \emph{date}'' (2); and ``what's the \emph{date} today?"
		\end{itemize}
	\end{itemize}
\end{alertblock}
...
\section[back-up slides]{AEM: An application from our own research}
